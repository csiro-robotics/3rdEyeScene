...
//             _platformWrapper = new StandaloneFileBrowserWindows();
        ...
        /// <param name="args">Dialog control arguments</param>
        /// <param name="cb">Callback</param>
        public static void OpenFilePanelAsync(BrowserParameters args, Action<string[]> cb) {
            _platformWrapper.OpenFilePanelAsync(args, cb);
        }
        ...
        /// </summary>
        /// <param name="args">Dialog control arguments</param>
        public static string SaveFilePanel(BrowserParameters args) {
            return _platformWrapper.SaveFilePanel(args);
        }
