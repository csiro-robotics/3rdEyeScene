...
{
  /// <summary>
  /// Type conversion helper from <c>float</c> typed List and Array types.
  /// </summary>
  internal class SingleConverter : BufferConverter
  {
    /// <summary>
    ...
    {
      return (list != null) ? ((IList<float>)list).Count : 0;
    }
    ...
    {
      IList<float> srcList = (IList<float>)src;
    ...
    {
      IList<float> dstList = (IList<float>)dst;
      int readCount = 0;
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadSByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadByte(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadUInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadUInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadUInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadSingle(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadSingle();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadDouble(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (float)reader.ReadDouble();
        }
        ++readCount;
      }
      return readCount;
