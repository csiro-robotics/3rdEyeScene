...
{
  /// <summary>
  /// Type conversion helper from <c>ulong</c> typed List and Array types.
  /// </summary>
  internal class UInt64Converter : BufferConverter
  {
    /// <summary>
    ...
    /// </summary>
    public Tes.Net.DataStreamType DefaultPackingType { get { return Tes.Net.DataStreamType.UInt64; } }
    ...
    {
      return (list != null) ? ((IList<ulong>)list).Count : 0;
    }
    ...
    {
      IList<ulong> srcList = (IList<ulong>)src;
    ...
    {
      IList<ulong> dstList = (IList<ulong>)dst;
      int readCount = 0;
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadSByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadByte(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadUInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadUInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadUInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadSingle(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadSingle();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadDouble(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (ulong)reader.ReadDouble();
        }
        ++readCount;
      }
      return readCount;
