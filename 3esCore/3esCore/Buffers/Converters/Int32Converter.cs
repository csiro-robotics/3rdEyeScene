...
namespace Tes.Buffers.Converters
{
  ...
  internal class Int32Converter : BufferConverter
  {
    ...
    /// </summary>
    public Tes.Net.DataStreamType DefaultPackingType { get { return Tes.Net.DataStreamType.Int32; } }
    ...
    {
      return (list != null) ? ((IList<int>)list).Count : 0;
    }
    ...
    {
      IList<int> dstList = (IList<int>)dst;
      int readCount = 0;
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadSByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadByte(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadUInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadUInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadUInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadSingle(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadSingle();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadDouble(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (int)reader.ReadDouble();
        }
        ++readCount;
      }
      return readCount;
