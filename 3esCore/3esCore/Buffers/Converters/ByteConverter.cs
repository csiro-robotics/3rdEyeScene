...
{
  /// <summary>
  /// Type conversion helper from <c>byte</c> typed List and Array types.
  /// </summary>
  internal class ByteConverter : BufferConverter
  {
    /// <summary>
    ...
    /// </summary>
    public Tes.Net.DataStreamType DefaultPackingType { get { return Tes.Net.DataStreamType.Byte; } }
    ...
    {
      return (list != null) ? ((IList<byte>)list).Count : 0;
    }
    ...
    {
      IList<byte> srcList = (IList<byte>)src;
    ...
    {
      IList<byte> dstList = (IList<byte>)dst;
      int readCount = 0;
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadSByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadByte(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadUInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadUInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadUInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadSingle(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadSingle();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadDouble(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (byte)reader.ReadDouble();
        }
        ++readCount;
      }
      return readCount;
