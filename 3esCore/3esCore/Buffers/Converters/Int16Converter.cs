...
{
  /// <summary>
  /// Type conversion helper from <c>short</c> typed List and Array types.
  /// </summary>
  internal class Int16Converter : BufferConverter
  {
    /// <summary>
    ...
    /// </summary>
    public Tes.Net.DataStreamType DefaultPackingType { get { return Tes.Net.DataStreamType.Int16; } }
    ...
    {
      return (list != null) ? ((IList<short>)list).Count : 0;
    }
    ...
    {
      IList<short> srcList = (IList<short>)src;
    ...
    {
      IList<short> dstList = (IList<short>)dst;
      int readCount = 0;
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadSByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadByte(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadByte();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt16(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadUInt16();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt32(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadUInt32();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadUInt64(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadUInt64();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadSingle(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadSingle();
        }
        ++readCount;
      }
      return readCount;
    ...
    public int ReadDouble(IList dst, BinaryReader reader, int offset, int count, int componentCount)
    {
      ...
      for (int i = 0; i < count; ++i)
      {
        for (int c = 0; c < componentCount; ++c)
        {
          dstList[(i + offset) * componentCount + c] = (short)reader.ReadDouble();
        }
        ++readCount;
      }
      return readCount;
